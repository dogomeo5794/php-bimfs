...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 12, 2019 at 05:25 PM
...
(9, 'Aefa1', 'Ae1', 'W1', 'female', '2001-05-20', '2019-10-16', 51, '123451', '2001-05-05', '81.00', 'Center1', '2019-10-16', 'Center1', 'Werg1', 'Srt1', 'Adfv1', 'Erg1', 'Srg1', 'Sgt1', 2, 1, 0),
(10, 'Ronaldo1', 'Dela pena1', 'Dogomeo1', 'female', '1991-05-07', '2019-11-03', 21, '1234567001', '1991-05-07', '50.01', 'Toboso, center1', '2019-11-03', 'Toboso, center1', 'Analiza dogomeo', 'Elementary level1', 'None1', 'Saturnino dogomeo1', 'Elementary graduate1', 'Carpenter1', 3, 1, 0);
...
(8, 'tubercolosis', NULL, NULL, 25),
(9, 'sobra sa 14 ka adlaw nga ubo', NULL, NULL, 25),
(10, 'sakit sa corazon', NULL, NULL, 25),
(11, 'diabetes', NULL, NULL, 25),
(12, 'hapo', NULL, NULL, 25),
(13, 'goiter', NULL, NULL, 25),
(14, 'tubercolosis', NULL, NULL, 26),
(15, 'sobra sa 14 ka adlaw nga ubo', NULL, NULL, 26),
(16, 'sakit sa corazon', NULL, NULL, 26),
(17, 'diabetes', NULL, NULL, 26),
(18, 'hapo', NULL, NULL, 26),
(19, 'goiter', NULL, NULL, 26);
...
(4, NULL, NULL, NULL, NULL, NULL, 25),
(5, NULL, NULL, NULL, NULL, NULL, 26);

-- --------------------------------------------------------

--
-- Table structure for table `give_birth`
--

CREATE TABLE `give_birth` (
  `birth_id` int(11) NOT NULL,
  `date_delivery` date NOT NULL,
  `time_delivery` time NOT NULL,
  `birth_status` varchar(50) NOT NULL,
  `birth_condition` varchar(50) NOT NULL,
...
--
-- Dumping data for table `give_birth`
--

INSERT INTO `give_birth` (`birth_id`, `date_delivery`, `time_delivery`, `birth_status`, `birth_condition`, `birth_weight`, `date_reg`, `pregnant_id`) VALUES
(1, '2019-10-20', '10:10:00', 'hu-o', 'hu-o', '20.00', '2019-11-12', 24);
...
(24, 'Sample 2', 'Sample 2', 'Sample 2', '1995-10-20', '', 'ab+', '2019-10-26', '2015-10-20', 'sample 3', '90.00', 1, 1, 0),
(25, 'Sample 333', 'Sf', 'Efrg', '1995-10-20', '', 'ab+', '2019-11-12', '2019-10-20', '1234567', '80.00', 1, 1, 0),
(26, 'Zzzzzz', 'Xx', 'Xxxx', '1990-10-20', '', 'o-', '2019-11-12', '2018-10-20', '12345000', '80.00', 1, 1, 0);
...
(6, 'nakaagi ceasarian section', NULL, NULL, NULL, NULL, 25),
(7, '3 kasunod-sunod na hulugan', NULL, NULL, NULL, NULL, 25),
(8, 'bata nga binun-ag nga patay', NULL, NULL, NULL, NULL, 25),
(9, 'dinugo tapos pagbun-ag', NULL, NULL, NULL, NULL, 25),
(10, 'nakaagi ceasarian section', NULL, NULL, NULL, NULL, 26),
(11, '3 kasunod-sunod na hulugan', NULL, NULL, NULL, NULL, 26),
(12, 'bata nga binun-ag nga patay', NULL, NULL, NULL, NULL, 26),
(13, 'dinugo tapos pagbun-ag', NULL, NULL, NULL, NULL, 26);
...
(16, 'petsa sang pagprenatal', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 25),
(17, 'nagpangdugo (hu-o / wala)', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 25),
(18, 'impeksyon sang renion (hu-o / wala)', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 25),
(19, 'kabug-aton (kg)', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 25),
(20, 'presyon sang dugo', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 25),
(21, 'presyon sang dugo 140/90 o subra pa (hu-o / wala)', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 25),
(22, 'hilanat 380 o sobra pa (hu-o / wala)', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 25),
(23, 'malapsi (hu-o / wala)', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 25),
(24, 'abnormal ang kataason sang pagbusong (hu-o / hindi)', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 25),
(25, 'abnormal ang posisyon sang bata (hu-o / hindi)', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 25),
(26, 'wala magpitik ang corazon sang bata (hu-o / wala)', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 25),
(27, 'may palamanog (hu-o / wala)', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 25),
(28, 'impreksyon sa puerta (hu-o / wala)', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 25),
(29, 'resulta sang eksaminasion sang dugo, inih, venareal disease', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 25),
(30, 'petsa sang pagprenatal', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 26),
(31, 'nagpangdugo (hu-o / wala)', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 26),
(32, 'impeksyon sang renion (hu-o / wala)', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 26),
(33, 'kabug-aton (kg)', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 26),
(34, 'presyon sang dugo', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 26),
(35, 'presyon sang dugo 140/90 o subra pa (hu-o / wala)', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 26),
(36, 'hilanat 380 o sobra pa (hu-o / wala)', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 26),
(37, 'malapsi (hu-o / wala)', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 26),
(38, 'abnormal ang kataason sang pagbusong (hu-o / hindi)', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 26),
(39, 'abnormal ang posisyon sang bata (hu-o / hindi)', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 26),
(40, 'wala magpitik ang corazon sang bata (hu-o / wala)', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 26),
(41, 'may palamanog (hu-o / wala)', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 26),
(42, 'impreksyon sa puerta (hu-o / wala)', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 26),
(43, 'resulta sang eksaminasion sang dugo, inih, venareal disease', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 26);
...
(11, 'question 1', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 25),
(12, 'question 2', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 25),
(13, 'question 3', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 25),
(14, 'question 4', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 25),
(15, 'question 5', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 25),
(16, 'question 6', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 25),
(17, 'question 7', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 25),
(18, 'question 8', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 25),
(19, 'question 9', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 25),
(20, 'question 1', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 26),
(21, 'question 2', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 26),
(22, 'question 3', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 26),
(23, 'question 4', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 26),
(24, 'question 5', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 26),
(25, 'question 6', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 26),
(26, 'question 7', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 26),
(27, 'question 8', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 26),
(28, 'question 9', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 26);
...
--
-- Indexes for table `give_birth`
--
ALTER TABLE `give_birth`
...
--
ALTER TABLE `current_problem`
  MODIFY `cur_prob_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
...
--
-- AUTO_INCREMENT for table `give_birth`
--
ALTER TABLE `give_birth`
...
--
ALTER TABLE `prev_pregnant`
  MODIFY `prev_preg_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `trimester`
  MODIFY `trimester_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;

--
-- AUTO_INCREMENT for table `trimester_action`
--
ALTER TABLE `trimester_action`
  MODIFY `action_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
...
--
-- Constraints for table `give_birth`
--
ALTER TABLE `give_birth`
  ADD CONSTRAINT `give_birth_ibfk_1` FOREIGN KEY (`pregnant_id`) REFERENCES `parents` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
